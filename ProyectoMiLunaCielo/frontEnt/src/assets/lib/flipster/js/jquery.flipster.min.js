                ...
                return (
                    ...
                    P('<button class="' + T.button + " " + ("next" === e ? T.buttonNext : T.buttonPrev) + '" role="button" />')
                        .html(
                            ...
                            "custom" === I.buttons
                                ? n
                                : '<svg viewBox="0 0 13 20" xmlns="' + a + '" aria-labelledby="title"><title>' + n + '</title><polyline points="10,3 3,10 10,17"' + ("next" === t ? ' transform="rotate(180 6.5,10)"' : "") + "/></svg>")
                        )
                        .on("click", function (t) {
                ...
                if (!(p.length <= 1))
                    return (
                        "prev" === t
                            ...
                            : "number" == typeof t
                            ? (h = t)
                            : t !== D && ((h = p.index(t)), I.loop && e != h && (e == p.length - 1 && h != p.length - 2 && (h = 0), 0 == e && 1 != h && (h = p.length - 1))),
                        (s = p.eq(h)),
                ...
                v.hasClass(T.active) ||
                    (function () {
                        ...
                        if ((v.css("visibility", "hidden"), k(), p.length <= 1)) v.css("visibility", "");
                            ...
                            (t = !!I.style && "flipster--" + I.style.split(" ").join(" flipster--")),
                                v.addClass([T.main, M ? "flipster--transform" : " flipster--no-transform", t, I.click ? "flipster--click" : ""].join(" ")),
                                I.start && (h = "center" === I.start ? Math.floor(p.length / 2) : I.start),
                                y(h);
                            var e,
                                n,
                                i,
                                    ...
                                    n.on({
                                        ...
                                        "touchmove.flipster": function (t) {
                                            (t = t.originalEvent),
                                                ...
                                                (l = r - i),
                                                (o = s - a),
                                                30 < Math.abs(l) && Math.abs(o) < 100 && t.preventDefault();
                                        },
